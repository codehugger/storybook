...
class pddlListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by pddlParser#axiomDef.
    def enterAxiomDef(self, ctx:pddlParser.AxiomDefContext):
        pass

    # Exit a parse tree produced by pddlParser#axiomDef.
    def exitAxiomDef(self, ctx:pddlParser.AxiomDefContext):
        pass


    # Enter a parse tree produced by pddlParser#axiomDefBody.
    def enterAxiomDefBody(self, ctx:pddlParser.AxiomDefBodyContext):
        pass

    # Exit a parse tree produced by pddlParser#axiomDefBody.
    def exitAxiomDefBody(self, ctx:pddlParser.AxiomDefBodyContext):
        pass


    # Enter a parse tree produced by pddlParser#context.
    def enterContext(self, ctx:pddlParser.ContextContext):
        pass

    # Exit a parse tree produced by pddlParser#context.
    def exitContext(self, ctx:pddlParser.ContextContext):
        pass


    # Enter a parse tree produced by pddlParser#implies.
    def enterImplies(self, ctx:pddlParser.ImpliesContext):
        pass

    # Exit a parse tree produced by pddlParser#implies.
    def exitImplies(self, ctx:pddlParser.ImpliesContext):
        pass
    ...
    # Enter a parse tree produced by pddlParser#agent.
    def enterAgent(self, ctx:pddlParser.AgentContext):
        pass

    # Exit a parse tree produced by pddlParser#agent.
    def exitAgent(self, ctx:pddlParser.AgentContext):
        pass

...
typedVariableList
    : (NAME* VARIABLE* | singleTypeVarList+ VARIABLE*)
    ;
...
goalDesc
  ...
  | '(' 'intends' VARIABLE goalDesc ')'
  | '(' 'delegated' VARIABLE VARIABLE VARIABLE ')'
  | fComp
  ;
